...
public class LanceApiConverter {
    ...
    public static Type parseType(String typeStr) {
        ...
        if (clean.equals("boolean") || clean.equals("bool")) {
            return BOOLEAN;
        } else if (clean.equals("int8") || clean.equals("tinyint")) {
            return TINYINT;
        } else if (clean.equals("int16") || clean.equals("smallint")) {
            return SMALLINT;
        } else if (clean.equals("int32") || clean.equals("int")) {
            return INT;
        } else if (clean.equals("int64") || clean.equals("bigint")) {
            return BIGINT;
        } else if (clean.equals("float16") || clean.equals("float32") || clean.equals("float")) {
            return FLOAT;
        } else if (clean.equals("float64") || clean.equals("double")) {
            return DOUBLE;
        } else if (clean.equals("string") || clean.equals("utf8") || clean.equals("varchar")) {
            return VARCHAR;
        } else if (clean.equals("binary") || clean.equals("varbinary")) {
            return VARBINARY;
        } else if (clean.equals("date") || clean.equals("date32")) {
            return DATE;
        } else if (clean.equals("timestamp") || clean.equals("datetime")) {
            return DATETIME;
        }
        ...
        if (clean.startsWith("fixed_size_list<") && clean.endsWith(">")) {
        ...
        if (clean.startsWith("struct<") && clean.endsWith(">")) {
